...
public class HRQueueConfiguration : IEntityTypeConfiguration<HRQueue>
{
    public void Configure(EntityTypeBuilder<HRQueue> builder)
    {
        builder.ToTable("hr_queues", "helpdesk");
        ...
        builder.Property(e => e.Medlemmar).HasColumnName("medlemmar")
            .HasColumnType("jsonb");
    }
}
