...
/// <summary>
/// Adapter för HEROMA-export (semikolonseparerad CSV).
/// Förväntade kolumner: PERSNR;FNAMN;ENAMN;ANST_FORM;KOL_AVTAL;MANLON;ENHET_KOD
/// </summary>
public sealed class HeromaAdapter : IMigrationAdapter
{
    public SourceSystem Source => SourceSystem.HEROMA;

    private static readonly string[] ExpectedHeaders =
        ["PERSNR", "FNAMN", "ENAMN", "ANST_FORM", "KOL_AVTAL", "MANLON", "ENHET_KOD"];
    ...
    private static readonly Dictionary<string, string> FieldMap = new()
    {
        ...
        ["FNAMN"] = "Fornamn",
        ["ENAMN"] = "Efternamn",
        ["ANST_FORM"] = "Anstallningsform",
        ["KOL_AVTAL"] = "Kollektivavtal",
        ["MANLON"] = "Manadslon",
        ["ENHET_KOD"] = "Enhetskod"
    };
    ...
    public MigrationMapping[] GetDefaultMappings()
    {
        ...
        [
            ...
            MigrationMapping.Skapa(jobId, "FNAMN", "Fornamn"),
            MigrationMapping.Skapa(jobId, "ENAMN", "Efternamn"),
            MigrationMapping.Skapa(jobId, "ANST_FORM", "Anstallningsform"),
            MigrationMapping.Skapa(jobId, "KOL_AVTAL", "Kollektivavtal"),
            MigrationMapping.Skapa(jobId, "MANLON", "Manadslon"),
            MigrationMapping.Skapa(jobId, "ENHET_KOD", "Enhetskod"),
        ];
    }
}
